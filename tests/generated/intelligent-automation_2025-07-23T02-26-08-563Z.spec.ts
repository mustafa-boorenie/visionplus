...
test.describe('intelligent-automation', () => {
  test('The automation script is designed to navigate to a specific webpage and click on a visible popup button after ensuring the page is stable.', async ({ page }) => {
