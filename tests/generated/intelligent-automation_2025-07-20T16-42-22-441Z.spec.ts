...
test.describe('intelligent-automation', () => {
  test('Click on the image tab', async ({ page }) => {
    ...
    // Step 3: Click on a[aria-label='Images'],a[href*='/images'],a:has-text('Images'),a[role='tab']:has-text('Images'),[role='tab']:nth-of-type(2)
