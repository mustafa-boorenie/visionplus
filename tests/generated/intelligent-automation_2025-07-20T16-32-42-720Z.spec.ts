...
test.describe('intelligent-automation', () => {
  test('click on the link to the crealty ender v3', async ({ page }) => {
    ...
    // Step 3: Click on h2.s-size-mini-headline a:has-text('Creality Ender 3'),a:has-text('Creality Ender 3'),[role='link']:has-text('Creality Ender 3')
    await page.click('h2.s-size-mini-headline a:has-text(\'Creality Ender 3\')');
