...
test.describe('intelligent-automation', () => {
  test('The automation script is designed to access a specific webpage and interact with the "Network Participation" link once it is visible.', async ({ page }) => {
    ...
    // Step 3: Click on #network-participation-link,[data-testid='network-participation'],a:has-text('Network Participation')
