...
export class MediaLayerService {
  ...
  // Screenshot storage
  private async storeScreenshot(req: express.Request, res: express.Response) {
    try {
  ...
  private async getScreenshot(req: express.Request, res: express.Response) {
    try {
      const { id } = req.params;
  ...
  private async getSessionScreenshots(req: express.Request, res: express.Response) {
    try {
  ...
  private async startStream(req: express.Request, res: express.Response) {
    try {
  ...
  private async addStreamFrame(req: express.Request, res: express.Response) {
    try {
  ...
  private async getStreamInfo(req: express.Request, res: express.Response) {
    try {
      const { streamId } = req.params;
      const stream = this.streamSessions.get(streamId);
  ...
  private async stopStream(req: express.Request, res: express.Response) {
    try {
      const { streamId } = req.params;
      const stream = this.streamSessions.get(streamId);
  ...
  private async getMediaSessions(req: express.Request, res: express.Response) {
    try {
  ...
  private async cleanupSession(req: express.Request, res: express.Response) {
    try {
      const { sessionId } = req.params;
      let deletedCount = 0;
  ...
  private async cleanupOldMedia(req: express.Request, res: express.Response) {
    try {
